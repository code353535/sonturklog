<x-front.layout>
    ...
    <div class="basis-2/3 flex flex-col-reverse xl:flex-row">
        <div class="md:w-[600px] px-4 py-4 border">
            ...
            <form method="post" action="{{ route('site.destekform') }}" enctype="multipart/form-data">
                @csrf
                   <div class="grid grid-cols-5 gap-2 mt-6">
                    ...
                    <select name="dkategori" class="mt-1 block w-full border-gray-300 focus:border-orange-500 focus:ring-orange-500">
                        <option selected>Bir Kategori Seçin</option>
                        <option value="ihlal ve uygunsuzluk">İhlal ve Uygunsuzluk</option>
                        <option value="destek talebi">Destek Talebi</option>
                        <option value="öneriler">Öneriler</option>
            ...
            <span class="text-rose-500 mt-2 text-sm">@error('dkategori'){{ $message }}@enderror</span>
                        ...
                        <div class="col-span-5 mt-4 overflow-auto">
                            ...
                            <x-text-input type="text" name="dbaslik" class="mt-1 block w-full mb-2"/>
                        ...
                        <textarea class="ckeditor form-control" name="dmesaj"></textarea>
    ...
    <div class="flex flex-col  md:ml-6 xl:w-[220px]">
        <div class="px-4 py-4 bg-white border text-black font-bold text-xl oswald"><i class="fa-solid fa-envelope mr-2"></i>Bilet Oluştur</div>
