...
<div class="flex flex-col lg:px-[170px] px-6 max-md:px-0">
    <div class="flex flex-row justify-between md:py-4 text-black text-xs py-2 max-md:pl-6 border-gray-200 border-b-2">
        <!-- enüst sol -->
    ...
    <div class="flex flex-row py-1 md:py-4">
        <div class="flex items-center waviy md:text-7xl text-5xl tracking-widest oswald">
