...
<footer class="bg-white border-t-2 border-gray-200 border-solid roboto mt-16 lg:mx-[170px]">
  ...
  class="hidden fixed z-50 bottom-10 right-10 p-1 border-0 w-8 h-8 shadow-md bg-black hover:bg-orange-500 text-white text-lg font-semibold transition-colors duration-300">
